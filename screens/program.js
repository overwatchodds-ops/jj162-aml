...
export function screen() {
  ...
  return `
    <div class="py-8 space-y-6">
      ...
      <button onclick="go('staff')" class="w-full bg-indigo-600 text-white py-2.5 rounded-xl text-sm font-semibold hover:bg-indigo-700 transition">Continue to Personnel →</button>
